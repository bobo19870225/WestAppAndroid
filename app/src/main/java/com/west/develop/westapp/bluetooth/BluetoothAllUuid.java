...
public final class BluetoothAllUuid{
    ...
    */
	...
	public static final ParcelUuid CHAT_Secure =
			ParcelUuid.fromString("fa87c0d0-afac-11de-8a39-0800200c9a66");
	public static final ParcelUuid CHAT_INSecure =
			ParcelUuid.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
	...
	public static HashSet<ParcelUuid> ChatProfileServices =
			new HashSet<>(Arrays.asList(CHAT_Secure,CHAT_INSecure));
	...
	public int getProfileFromUuid(Parcelable uuid){
		...
		} else if (ChatProfileServices.contains(uuid)){
    ...
    public static int getServiceFromUuid(Parcelable uuid){
		...
		} else if (CHAT_INSecure.equals(uuid)){
			return Profile.ChatINSecureService;
		} else if(CHAT_Secure.equals(uuid)){
			return Profile.ChatSecureService;
		}
		else {
