...
public class ProlificSerialDriver implements UsbSerialDriver {
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        private boolean setControlLines(int newControlLinesValue) {
            try {
        ...
        private final boolean testStatusFlag(int flag){
        ...
        @Override
        public boolean setParameters(int baudRate, int dataBits, int stopBits,
                int parity){
