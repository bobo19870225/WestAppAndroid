...
/**
 * Created by Develop12 on 2017/11/28.
 */
public class MyVideoView extends SurfaceView
        implements MyMediaController.MyMediaPlayerControl {
    ...
    public boolean isFullScreen() {
        if (mORIENTATION == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE && mIsFullScreen) {
            mORIENTATION = ActivityInfo.SCREEN_ORIENTATION_SENSOR;
            mIsFullScreen = false;
        } else if (mORIENTATION == ActivityInfo.SCREEN_ORIENTATION_SENSOR && !mIsFullScreen) {
            mIsFullScreen = false;
        } else {
