...
import com.west.develop.westapp.videocache.file.DiskUsage;
import com.west.develop.westapp.videocache.file.FileNameGenerator;
import com.west.develop.westapp.videocache.file.Md5FileNameGenerator;
import com.west.develop.westapp.videocache.file.TotalCountLruDiskUsage;
import com.west.develop.westapp.videocache.file.TotalSizeLruDiskUsage;
import com.west.develop.westapp.videocache.headers.EmptyHeadersInjector;
import com.west.develop.westapp.videocache.headers.HeaderInjector;
import com.west.develop.westapp.videocache.sourcestorage.SourceInfoStorage;
import com.west.develop.westapp.videocache.sourcestorage.SourceInfoStorageFactory;
...
import static com.west.develop.westapp.videocache.Preconditions.checkAllNotNull;
import static com.west.develop.westapp.videocache.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    public String getProxyUrl(String url) {
         String str = getProxyUrl(url, true);
        return str;
    }
    ...
    private String appendToProxyUrl(String url) {
        url = ProxyCacheUtils.encode(url);
    ...
    public Long getCacheFileSize(String url) {
        Long size = getCacheFile(url).length();
        return  size;
    }

    public File getCacheFilePath(Context context){
