...
public class FtdiSerialDriver implements UsbSerialDriver {
    ...
    private class FtdiSerialPort extends CommonUsbSerialPort {
        ...
        @Override
        public void close() {
            Log.e("FtdiSerial","Close request");
            if (mConnection == null) {
                return;
        ...
        public int read(byte[] dest, int timeoutMillis) throws IOException {
            ...
            if (ENABLE_ASYNC_READS) {
                ...
                synchronized (mReadBufferLock) {
                    ...
                    if(mConnection == null){
                       // Log.e("PortRead","Null Connection");
                        return filterStatusBytes(mReadBuffer, dest, MODEM_STATUS_HEADER_LENGTH, endpoint.getMaxPacketSize());
                        //throw new IOException("Null Conncection");
                    }
        ...
        public int write(byte[] src, int timeoutMillis) {
            Log.e("write",HexDump.dumpHexString(src));
        ...
        private void setDtrRts() {
            ...
            mConnection.controlTransfer(
                    ...
                    SIO_MODEM_CTRL_REQUEST, /* Set the modem control register */
